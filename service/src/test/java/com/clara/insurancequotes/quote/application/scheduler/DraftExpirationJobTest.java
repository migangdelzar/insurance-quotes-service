package com.clara.insurancequotes.quote.application.scheduler;
...
class DraftExpirationJobTest {
    ...
    void expiresOnlyDraftsOlderThanTtl_andPublishesOneEventPerQuote() {
        ...
        var job = new DraftExpirationJob(repository, events, clockAfterTtl, Duration.ofMinutes(30));
    ...
    void noStaleDrafts_returnsZeroAndPublishesNothing() {
        ...
        var job = new DraftExpirationJob(repository, events, clockWithinTtl, Duration.ofMinutes(30));
